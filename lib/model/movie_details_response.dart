...
class MovieDeateailsResponse {
  String? status;
  String? statusMessage;
  Data? data;


  MovieDeateailsResponse({this.status, this.statusMessage, this.data, });

  MovieDeateailsResponse.fromJson(Map<String, dynamic> json) {
    status = json["status"];
  ...
  static List<MovieDeateailsResponse> fromList(List<Map<String, dynamic>> list) {
    return list.map(MovieDeateailsResponse.fromJson).toList();
  }
